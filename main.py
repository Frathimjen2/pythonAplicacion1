...
def ventana_agregar():
    ...
    menu = tk.Button(window, text="MENU", fg="red", font=("arial", 12), cursor="hand2", relief="raised",
    ...
    btguardar = tk.Button(window, text="GUARDAR", fg="blue", font=("arial", 12), cursor="hand2", relief="raised",
                          command=guarda)
    btguardar.pack()
...
def ventana_ver():
    ...
    bt_mostrar = tk.Button(window, text="MOSTRAR PRODUCTOS", fg="blue", font=("arial", 12), cursor="hand2",
                           relief="raised", command=mostrar)
    bt_mostrar.pack()
...
def ventana_eliminar():
    ...
    menu.pack()
    menu.place(x=50, y=350)
    bt_eliminar = tk.Button(window, text="ELIMINAR PRODUCTOS", fg="blue", font=("arial", 12), cursor="hand2",
                            relief="raised", command=eliminar)
    bt_eliminar.pack()
...
def modificar_producto():
    ...
    menu.pack()
    menu.place(x=50, y=350)
    bt_modificar = tk.Button(window, text="MODIFICAR PRODUCTO", fg="blue", font=("arial", 12), cursor="hand2",
                             relief="raised", command=modificar)
    bt_modificar.pack()
...
b1 = tk.Button(windows, text="Agregar Producto", fg="blue", font=("arial", 14), borderwidth=10, cursor="hand2",
               relief="raised", command=ventana_agregar, )
b1.pack()
b1.place(x=5, y=50)

b2 = tk.Button(windows, text="Buscar Producto", fg="blue", font=("arial", 14), borderwidth=10, cursor="hand2",
               relief="raised", command=ventana_ver)
b2.pack()
b2.place(x=5, y=150)

b3 = tk.Button(windows, text="Eliminar Producto", fg="blue", font=("arial", 14), borderwidth=10, cursor="hand2",
               relief="raised", command=ventana_eliminar)
b3.pack()
b3.place(x=5, y=250)

b4 = tk.Button(windows, text="Modificar Producto", fg="blue", font=("arial", 14), borderwidth=10, cursor="hand2",
               relief="raised", command=modificar_producto)
b4.pack()
b4.place(x=5, y=350)
